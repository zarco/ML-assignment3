...
class DrugConsumptionData(DataLoader):
    def __init__(self, path='data/cannabis_consumption.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
...
if __name__ == '__main__':
    cd_data = PenDigitData(verbose=True)
